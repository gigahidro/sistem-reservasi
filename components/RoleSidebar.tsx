...
import { LayoutDashboard, Users, TableProperties, ClipboardList, CreditCard, UserCheck, LogOut, LayoutGrid, Menu, X, type LucideIcon } from "lucide-react";
    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between px-5 py-4 shrink-0 shadow-sm relative z-20"
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-extrabold tracking-widest text-sm">YUMFOOD <span style={{color: roleBadgeColor}} className="ml-1">({roleLabel})</span></span>
        </div>
