...
const navLinks = [
  { href: "/dashboard", label: "Denah Restoran", icon: LayoutGrid, exact: true },
  { href: "/dashboard/riwayat", label: "Riwayat Reservasi", icon: History, exact: false },
  { href: "/dashboard/notifikasi", label: "Notifikasi", icon: Bell, exact: false },
];
    ...
    >
      ...
      <div className="mb-8">
        ...
        <div className="text-center">
          ...
          {/* RESTAURANT & DINING with orange underline */}
